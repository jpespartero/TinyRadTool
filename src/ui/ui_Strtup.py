...
class Ui_Strtup(object):
    def setupUi(self, Dialog):
        ...
        self.ChkBox_Agree.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        self.ChkBox_Agree.setObjectName(_fromUtf8("ChkBox_Agree"))
        self.verticalLayout_3.addWidget(self.ChkBox_Agree, QtCore.Qt.AlignmentFlag.AlignRight)
